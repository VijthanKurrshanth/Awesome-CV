...
\cventry
{\textbf{Tech Stack :} OpenAirInterface5G, srsRAN, Docker, Software Designed Radios, Python, Flask, Unity, RaspberryPi} % Affiliation/role
{5G Powered Smart Warehouse - Final Year Project} % Organization/group
{\href{https://github.com/Stealth-Devs-Org/Stealth-SDC-Sem6}{}} % Location
...
{Flower Exchange - Trading Application} % Organization/group
...
\cventry
{\textbf{Tech Stack :} GNURadio, GNUOctave, Software Defined Radios} % Affiliation/role
{QPSK Digital Transceiver} % Organization/group
