...
{Axiata Digital Labs (Pvt) Ltd} % Organization
{Colombo, Sri Lanka} % Location
{Nov. 2023 - May. 2024} % Date(s)
{ % Description(s) of tasks/responsibilities
\begin{cvitems}
\item {\textbf{Tech Stack :} \textit{OpenAirInterface5G, Docker, Kubernetes, Axonect Enterprise Enabler, MySQL, MongoDB, Springboot, Angular, REST API}}
